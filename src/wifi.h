...
#include "types.h"
	...
	#define _INC_STDIO
	#define DEFAULT_WFCSERVER_DNS "104.131.93.87" //Defaulting to the AltWFC server
#endif
...
extern WifiHandler *CurrentWifiHandler;		//does that one really have to be stored as well?
